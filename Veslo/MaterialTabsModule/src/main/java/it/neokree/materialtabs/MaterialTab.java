...
public class MaterialTab implements View.OnTouchListener {
    ...
    private final static int REVEAL_DURATION = 300;
   ...
   private int getTextLenght() {
    ...
    public void setIconWidth(int dp) {
        icon.getLayoutParams().width = (int) (dp * density);
        icon.getLayoutParams().height = (int) (dp * density);
        icon.requestLayout();
    }
}
